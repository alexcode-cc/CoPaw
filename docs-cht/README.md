...
| [Mac Mini M4 16GB 實作指南](./mac-mini-m4-copaw-implement.md) | 從無到有部署 CoPaw，整合 Ollama/Claude + Discord + Gmail + GitHub |
| [Mac Mini M4 24GB 實作指南](./mac-mini-m4-24g-copaw-implement.md) | 24GB 版，完整模型選擇、記憶體優化、本地 Embedding、MLX 後端 |
